...
class ReturnPolicy(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    supplier = models.OneToOneField('accounts.Supplier', on_delete=models.CASCADE, related_name='return_policy', verbose_name=_("Supplier"))
    ...
    def __str__(self):
        return f"{self.title} - {self.supplier.user.get_full_name}"