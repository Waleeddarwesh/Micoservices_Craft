...
@shared_task(name="update_delivery_tiers_task")
def update_delivery_tiers_task():
    from .models import Delivery
    for delivery in Delivery.objects.all():
        delivery.update_performance_tier()
    print("✅ Successfully updated performance tiers for all delivery personnel.")